package com.nwafu.organizepaper.aop;

import com.nwafu.organizepaper.OrganizepaperApplication;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.nwafu.organizepaper.controller.*.*(..))")
    public void webLog() {
    }
